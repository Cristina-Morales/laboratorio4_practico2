      ...
      if (_searchQuery.isEmpty) {
        ...
        _auxiliarElements = elementos.where((elemento) {
          String nombreCompleto =
              "${elemento[1].toString().toLowerCase()} ${elemento[0].toString().toLowerCase()}";
          String nombreCompletoinverso =
              "${elemento[0].toString().toLowerCase()} ${elemento[1].toString().toLowerCase()}";

          return nombreCompleto.contains(_searchQuery.toLowerCase()) ||
              nombreCompletoinverso.contains(_searchQuery.toLowerCase()) ||
              elemento[4]
                  .toString()
                  .toLowerCase()
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Image.asset(
                        'assets/avatars/${_auxiliarElements[index][5]}.png',
                        width: 50,
                        height: 50),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_auxiliarElements[index][4])
                        ],
                      ),
                    ),
                  ],
